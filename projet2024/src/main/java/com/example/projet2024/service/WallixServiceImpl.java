...
public class WallixServiceImpl implements IWallixService {
    ...
    @Override
    public Wallix updateWallixFile(Long wallixId, String fichier, String fichierOriginalName) {
        Wallix wallix = wallixRepo.findById(wallixId).orElse(null);
        if (wallix != null) {
            wallix.setFichier(fichier);
            wallix.setFichierOriginalName(fichierOriginalName);
            return wallixRepo.save(wallix);
        }
        return null;
    }
