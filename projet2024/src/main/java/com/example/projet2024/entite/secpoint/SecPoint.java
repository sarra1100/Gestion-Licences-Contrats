package com.example.projet2024.entite.secpoint;
...
public class SecPoint {
    ...
    @OneToMany(mappedBy = "secPoint", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonManagedReference("secpoint-licence")
