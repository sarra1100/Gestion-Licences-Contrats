package com.example.projet2024.entite.vmware;
...
public class VMware {
    ...
    @OneToMany(mappedBy = "vmware", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonManagedReference("vmware-licence")
