package com.example.projet2024.entite.microsofto365;
...
@Setter
@Entity
@Table(name = "MicrosoftO365")
public class MicrosoftO365 {
    @Id
    @Column(name = "MicrosoftO365Id")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long microsoftO365Id;

    @Basic
    @Column(name = "Client")
    private String client;

    @OneToMany(mappedBy = "microsoftO365", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonManagedReference("microsoft-licence")
