...
@Entity
@Table(name = "Imperva")
public class Imperva {
    @Id
    @Column(name = "ImpervaId")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long impervaId;

    @Basic
    @Column(name = "Client")
    private String client;

    @OneToMany(mappedBy = "imperva", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonManagedReference("imperva-licence")
